...
<head>
    ...
    <meta name="description" content="JPG SAOP - {{ trans('adminlte_lang::message.landingdescription') }} ">
    <meta name="author" content="Sergi Tur Badenas - acacha.org">

    <meta property="og:title" content="JPG SAOP" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="JPG SAOP - {{ trans('adminlte_lang::message.landingdescription') }}" />
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>JPG SAOP</b></a>
            </div>
